---
title: ফাইল সিস্টেম / স্টোরেজ
type:  হ্যালো লারাভেল ৫ । ৪
order: 15
---

## পরিচিতি
ফাইল বলতে মূলত ছবি , ভিডিও , পি ডি এফ এসব বুজায় । যেকোনো সাইট আ এসব থাকে । ফাইল গুলো স্টোরেজ এ থাকে , সেতা হতে পারে `লোকাল` , `অ্যামাজন এর S3` , `Rackspace`, `Dropbox` ।


## কনফিগারেশন

ফাইল সিস্টেম/ স্টোরেজ কনফিগারেশন পাওয়া যাবে   `config/filesystems.php` এখানে । যেটা দেখতে এরকম ।
...
```
`default` হিসেবে `local` - `disks` থাকে । `disks` পরিবর্তন করে স্টোরেজ করবেন কোথায় ,সেটা ফিক্সড করতে পারবেন ।
...
```php
Storage::disk('public')->get('file.jpg');
```
```php
...
### Custom Filesystems ()
 [Dropbox Filesystem](https://medium.com/hello-laravel/dropbox-filesystem-laravel-5-4-dfb60a618d6e)
