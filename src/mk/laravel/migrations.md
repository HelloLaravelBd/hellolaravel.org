...
The Laravel `Schema` [facade](/mk/laravel/facades.html) provides database agnostic support for creating and manipulating tables across all of Laravel's supported database systems.

<a name="generating-migrations"></a>
## Generating Migrations

To create a migration, use the `make:migration` [Artisan command](/mk/laravel/artisan.html):
```php
...
```php
    php artisan migrate
```
> {note} If you are using the [Homestead virtual machine](/mk/laravel/homestead.html), you should run this command from within your virtual machine.
