...
```
If you are sending mail in this way you should convert these calls to [mailables](/mk/laravel/mail.html).
...
Once you have completed these preparatory steps, you can follow the normal [Dusk installation instructions](/mk/laravel/dusk.html#installation).
