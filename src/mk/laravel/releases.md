...
Laravel 5.3 makes API authentication a breeze using [Laravel Passport](/mk/laravel/passport.html), which provides a full OAuth2 server implementation for your Laravel application in a matter of minutes. Passport is built on top of the [League OAuth2 server](https://github.com/thephpleague/oauth2-server) that is maintained by Alex Bilbie.
...
```
For more information on storing uploaded files, check out the [full documentation](/mk/laravel/filesystem.html#file-uploads).
...
For more information on writing global scopes, check out the full [Eloquent documentation](/mk/laravel/eloquent.html#global-scopes).

<a name="laravel-5.1.11"></a>
## Laravel 5.1.11

Laravel 5.1.11 introduces [authorization](/mk/laravel/authorization.html) support out of the box! Conveniently organize your application's authorization logic using simple callbacks or policy classes, and authorize actions using simple, expressive methods.

For more information, please refer to the [authorization documentation](/mk/laravel/authorization.html).

<a name="laravel-5.1.4"></a>
## Laravel 5.1.4

Laravel 5.1.4 introduces simple login throttling to the framework. Consult the [authentication documentation](/mk/laravel/authentication.html#authentication-throttling) for more information.
...
To learn more about event broadcasting, check out the [event documentation](/mk/laravel/events.html#broadcasting-events).
...
```
For more information on middleware, check out the [middleware documentation](/mk/laravel/middleware.html).
...
```
For more information on testing, check out the [testing documentation](/mk/laravel/testing.html).

### Model Factories

Laravel now ships with an easy way to create stub Eloquent models using [model factories](/mk/laravel/database-testing.html#writing-factories). Model factories allow you to easily define a set of "default" attributes for your Eloquent model, and then generate test model instances for your tests or database seeds. Model factories also take advantage of the powerful [Faker](https://github.com/fzaninotto/Faker) PHP library for generating random attribute data:
```php
...
```
For more information on model factories, check out [the documentation](/mk/laravel/database-testing.html#writing-factories).
...
```
For more information on defining Artisan commands, consult the [Artisan documentation](/mk/laravel/artisan.html).
...
For more information on contracts, consult the [full documentation](/mk/laravel/contracts.html).
...
For more information on middleware, check out [the documentation](/mk/laravel/middleware.html).

### Controller Method Injection

In addition to the existing constructor injection, you may now type-hint dependencies on controller methods. The [service container](/mk/laravel/container.html) will automatically inject the dependencies, even if the route contains other parameters:
```php
...
```
For more information on working with events, check out the [full documentation](/mk/laravel/events.html).
...
```
Of course, you may also use commands for tasks that are executed synchronously (are not queued). In fact, using commands is a great way to encapsulate complex tasks your application needs to perform. For more information, check out the [command bus](/mk/laravel/bus.html) documentation.
...
```
Of course, check out the [full documentation](/mk/laravel/scheduling.html) to learn all about the scheduler!
...
For more information on Elixir, check out the [full documentation](/mk/laravel/elixir.html).
...
```
No more spending hours writing OAuth authentication flows. Get started in minutes! The [full documentation](/mk/laravel/authentication.html#social-authentication) has all the details.
...
```
For more information on the Laravel Flysystem integration, consult the [full documentation](/mk/laravel/filesystem.html).
...
For more information on this new method, check out [the documentation](/mk/laravel/validation.html#validation-quickstart).
